...
export function sidebar() {
    ...
    <img class="bx bxl-c-plus-plus icon" id="logo_verde_blanco" src="./public/assets/img/Logo verde-blanco.svg" alt="">
    <img  class="logo-isotipo" src="./public/assets/img/isotipo-verde.svg" alt="">
